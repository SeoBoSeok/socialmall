...
foreach((array) $list as $row){
	...
	//echo "<div class=\"sct_btn\"> <button type=\"button\" class=\"btn_cart sct_cart\" data-it_id=\"{$row['it_id']}\"><i class=\"fa fa-shopping-cart\" aria-hidden=\"true\"></i> 장바구니</button>\n";
	// echo "</div>\n";

    echo '<div class="sct_btn"><div class="sct_cart_btn"><button type="button" class="btn_cart" data-it_id="1606803518"><span class="sound_only">장바구니</span><i class="fa fa-shopping-cart" aria-hidden="true"></i></button><button type="button" class="btn_wish" data-it_id="1606803518"><span class="sound_only">위시리스트</span><i class="fa fa-heart" aria-hidden="true"></i></button></div></div>';
