...
<div id="hd">
    ...
    <div id="hd_wrapper">
        <div id="logo">
        	<a href="<?php echo G5_SHOP_URL; ?>/"><img src="<?php echo G5_IMG_URL; ?>/logo_top.png" alt="<?php echo $config['cf_title']; ?>" width="300px"></a>
        </div>
...
<nav id="gnb">
  <div class="gnb_wrap">
    <ul id="gnb_1dul">
      <li class="">
        <a href="/bbs/content.php?co_id=introduce" target="_self" class="gnb_1da">단체소개</a>
      </li>
      <li class="">
        <a href="/bbs/board.php?bo_table=market" target="_self" class="gnb_1da">상점소개</a>
      </li>
      <li class="">
        <a href="/bbs/board.php?bo_table=category" target="_self" class="gnb_1da">카테고리</a>
      </li>
      <li class="">
